...
namespace BrushFilter.Gui
{
    public partial class BrushFilterPreferences : Form
    {
        public BrushFilterPreferences()
        {
            InitializeComponent();
            Icon = Resources.Icon;
            CenterToScreen();
        ...
        /// </summary>
        private void winBrushFilterPreferences_DialogLoad(object sender, EventArgs e)
        {
